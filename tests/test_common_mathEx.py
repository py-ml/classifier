...
from clsfr.common.mathEx import \
...
class MathExTests(unittest.TestCase):
    """
    mathExTests includes all unit tests for clsfr.common.mathEx module
    """
    @classmethod
    ...
    def setUp(self):
        ...
        self.base_path = os.path.join(self.repo_path, "clsfr", "common")
        self.data_path = os.path.join(self.repo_path, "clsfr", "common", "datasets")
        pass
    ...
    def test_change_to_multi_class(self):
        """
        test clsfr.common.mathEx.change_to_multi_class
        @return:
        """
        tests = [
    ...
    def test_compute_cost(self):
        """
        test clsfr.common.mathEx.compute_cost
        @return:
        """
        tests = [{
            "al": [[0.5]], "y": [[0.6]],
    ...
    def test_compute_cost_with_l2_regularization(self):
        """
        test clsfr.common.mathEx.compute_cost_with_l2_regularization
        @return:
        """
        tests = [{
            "al": [[0.01, 0.1, 0.2, 0.3], [0.1, 0.2, 0.3, 0.4]],
    ...
    def test_relu_backward(self):
        """
        test clsfr.common.mathEx.relu_backward
        @return:
        """
        tests = [{
            "da": [[1], [2], [3], [4]],
    ...
    def test_leaky_relu(self):
        """
        test clsfr.common.mathEx.leaky_relu
        @return:
        """
        tests = [{
            "z": [[-1], [0], [1], [2]],
    ...
    def test_leaky_relu_backward(self):
        """
        test clsfr.common.mathEx.leaky_relu_backward
        @return:
        """
        tests = [{
            "da": [[1], [2], [3], [4]],
    ...
    def test_sigmoid(self):
        """
        test clsfr.common.mathEx.sigmoid
        @return:
        """
        tests_array = [{
            "z": [[0]],
    ...
    def test_sigmoid_backward(self):
        """
        test clsfr.common.mathEx.sigmoid_backward
        @return:
        """
        tests_array = [{
            "da": [[0.5]],
    ...
    def test_l_model_forward(self):
        """
        test clsfr.common.l_model_forward
        @return:
        """
        tests = [{
    ...
    def test_l_model_backward_with_l2(self):
        """
        test clsfr.common.mathEx.l_model_backward_with_l2
        @return:
        """
        tests = [{
            "al": numpy.array([[0.5, 0.5], [0.5, 0.5]]),
    ...
    def test_one_vs_all_prediction(self):
        """
        test clsfr.common.mathEx.one_vs_all_prediction
        @return:
        """
        tests = [{
            "pm": [[0], [0.1], [0.2]],
