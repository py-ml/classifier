...
from clsfr.utils.extension import DictEncoder, JsonEncoder
from clsfr.utils.extension import check_duplicate_key
from clsfr.utils.extension import check_valid_md5
from clsfr.utils.extension import del_attr
from clsfr.utils.extension import get_attr
from clsfr.utils.extension import get_camel_title_word
from clsfr.utils.extension import get_hash
from clsfr.utils.extension import get_json
from clsfr.utils.extension import pickle_object
from clsfr.utils.extension import pickle_to_str

LOGGER = getLogger('clsfr.'+__name__)
...
class ExtensionTests(unittest.TestCase):
    ...
    def test_check_duplicate_key(self):
        """
        test clsfr.utils.extension.check_duplicate_key
        """
        tests = [
            {
    ...
    def test_check_valid_md5(self):
        """
        test clsfr.utils.extension.check_valid_md5
        """
        tests = [
    ...
    def test_dict_encoder(self):
        """
        test clsfr.utils.extension.DictEncoder
        """
        test = EncodeTest()
        expected = """
    ...
    def test_get_attr(self):
        """
        test clsfr.utils.extension.get_attr
        """
        aaa = ['a', 'aa', 'aaa']
        obj = [{
    ...
    def test_get_attr_from_object(self):
        """
        test clsfr.utils.extension.get_attr (object)
        """
        tests = [
    ...
    def test_get_camel_title_word(self):
        """
        test clsfr.utils.extension.get_camel_title_word
        """
        tests = [
    ...
    def test_get_hash(self):
        """
        test clsfr.utils.extension.get_hash
        """
    ...
    def test_get_hash_from_file(self):
        """
        test clsfr.utils.extension.get_hash from file
        """
    ...
    def test_get_hash_from_large_file(self):
        """
        test clsfr.utils.extension.get_hash from large file
        """
    ...
    def test_get_hash_on_exception(self):
        """
        test clsfr.utils.extension.get_hash on exception
        """
        orig_func = os.path.getsize
    ...
    def test_get_json(self):
        """
        test clsfr.utils.extension.get_json
        """
        tests = [
            {
    ...
    def test_pickle_object(self):
        """
        test clsfr.utils.extension.pickle_object
        """
        test = EncodeTest()
    ...
    def test_pickle_to_str(self):
        """
        test clsfr.utils.extension.pickle_to_str
        """
