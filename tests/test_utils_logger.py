...
from clsfr.utils.logger_formatter import factory
from clsfr.utils.logger import get_logger
from clsfr.utils.logger import print_info
from clsfr.utils.logger import raise_ni
...
class LoggerTests(unittest.TestCase):
    """
    LoggerTests includes all unit tests for clsfr.urils.logger module
    """
    @classmethod
    ...
    def test_formatter_factory(self):
        """
        test clsfr.utils.logger_formatter.factory
        """
    ...
    def test_get_logger(self):
        """
        test clsfr.utils.logger.get_logger
        """
        import re
        print_info()
    ...
    def test_raise_ni(self):
        """
        test clsfr.utils.logger.raise_ni
        """
