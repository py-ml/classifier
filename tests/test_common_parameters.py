...
class DrDataSvcTests(unittest.TestCase):
    """
    DrDataSvcTests includes all unit tests for clsfr.common.parameters module
    """
    @classmethod
    ...
    @patch('clsfr.common.parameters.np')
    def test_load(self, mock_np):
        """
        test clsfr.common.parameters :: Parameters :: load
        """
        from clsfr.common.parameters import Parameters
    ...
    def test_save(self, mock_np):
        """
        test clsfr.common.parameters :: Parameters :: save
        """
        from clsfr.common.parameters import Parameters
    ...
    def test_update(self):
        """
        test clsfr.common.parameters :: Parameters :: update
        @return:
        """
        from clsfr.common.parameters import Parameters
    ...
    def test_initialize_parameters_deep_he(self):
        """
        test clsfr.common.parameters :: Parameters :: initialize_parameters_deep_he
        @return:
        """
        from clsfr.common.parameters import Parameters
